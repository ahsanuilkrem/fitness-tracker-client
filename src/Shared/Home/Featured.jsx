...
const Featured = () => {
    return (
        <>
        <div className=' mt-12'>
            <h2 className='text-2xl font-bold text-center'> Fitness Programmes At Syncfit </h2>
            <p className='text-xs font-mono text-center'>if you wont to be fit, you need to start today</p>
        </div>
